...
val logger = KotlinLogging.logger("Learning Coroutines")
...
suspend fun prepareBreakfast() {
    coroutineScope {
        val coffee: Deferred<String> = async { preparingJavaCoffee() } // Deferred = analogous to the Future[T]
...
suspend fun prepareBreakfastAwaitAll() {
    coroutineScope {
