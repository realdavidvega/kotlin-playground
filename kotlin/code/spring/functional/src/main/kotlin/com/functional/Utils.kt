...
inline fun <reified T : Any> springApplication(init: SpringApplication.() -> Unit): SpringApplication =
    SpringApplication(T::class.java).apply(init)

@Suppress("SpreadOperator")
fun <A> ConfigurableApplicationContext.getBeanWithGenerics(
    aParent: Class<A>, vararg generics: Class<*>
): A {
